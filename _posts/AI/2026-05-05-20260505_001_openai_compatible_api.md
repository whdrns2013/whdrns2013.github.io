---
title: "[LLM] OpenAI Compatible API (오픈AI 호환 API 형식)" # 제목 (필수)
...
lastmod: 2026-05-11 00:17:00 +0900   # 최종 수정일 (필수)
last_modified_at: 2026-05-11 00:17:00 +0900   # 최종 수정일 (필수)
...
- 요청 바디 중 messages 부분의 구조  

```json
messages = [
    // 1. 이전 대화 내역 :: {'role', 'conetent'} 구조를 가짐
    {
        "role": "system",
        "content": "당신은 유용한 AI 도우미입니다. 사용자의 질문에 답변하세요."
    },
    {
        "role": "user",
        "content": "첫 번째 메시지입니다."
    ...
    {
        "role": "assistant",
        "content": "사용자의 질문인 첫 번째 메시지입니다.에 대한 답변입니다.",
    },
    {
        "role": "user",
        "content": "두 번째 메시지입니다."
    ...
    {
        "role": "assistant",
        "content": "사용자의 질문인 두 번째 메시지입니다.에 대한 답변입니다.",
    },

    // 2. 현재 사용자 요청 :: 보통 마지막 메시지. 
    {
        "role": "user", // (1) role 필드 : 사용자 요청이 정상적으로 들어왔다면 user일 것
        "content": [    // (2) content 필드 : {'type', '내용'} 구조를 가짐
            {
                "type": "text",              // a. 텍스트 입력인 경우 type = text
                "text": "채팅창에 입력한 텍스트"  // b. 텍스트 입력은 'text' 필드에 들어옴
            },
            {
                "type": "image_url",  // c. 첨부 이미지인 경우 type = image_url
                "image_url": {        // d. 이미지 내용은 image_url.url 필드에 들어옴
                    "url": "data:image/png;base64.iVBORw0KGgoAAAANSUh..." // 단순 첨부시 Base64 인코딩값이 옴  
                },
            },
            { 
                "type": "image_url",  // e. 첨부파일이 두 개 이상인 경우 여러 개의 content 가 생김. 구조는 동일
                "image_url": {
                    "url": "data:image/png;base64.g03jfSADF34fj034HD3..."
                },
            },
            {
                "type": "image_url",
                "image_url": {
                    "url": "data:image/png;base64.480fj3DFF241faDS165..."
                },
            },
        ],
    },
