...
> [SSRF : 클라이언트가 자신이 필요로 하는 요청을 서버가 대신 시도하게 하는 악용]((https://whdrns2013.github.io/security/20260913_001_openai_huggingface_ai_hacking_ssrf/))  
...
에이전트들은 제 3자 호스팅 제공 업체(Modal) 에서 기본으로 제공되는 API 키를 발견하고, [SSRF](https://whdrns2013.github.io/security/20260913_001_openai_huggingface_ai_hacking_ssrf/), Command Injection 공격, 제로데이 취약점들을 조합하고 연쇄적으로 악용하여 단 13시간 만에 **HuggingFace의 복수의 운영 클러스터 관리자 권한을 장악**하는 다양한 기법을 조합한 공격 양상을 보였다.    
