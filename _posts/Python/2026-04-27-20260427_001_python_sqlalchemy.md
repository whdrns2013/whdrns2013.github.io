...
lastmod: 2026-05-10 09:58:00 +0900   # 최종 수정일 (필수)
last_modified_at: 2026-05-10 09:58:00 +0900   # 최종 수정일 (필수)
...
| `default` | default=datetime.utcnow() | Python 쪽 기본값 (SQLAlchemy 단에서 Insert할 때 적용)<br>DDL에 반영되지 않음. 동적인 값 할당 가능.|
| `server_default` | server_default=text("now()") | DB 서버 기본값 (DB에 Insert될 때 적용)<br>DDL에 반영됨. 문자열로 전달해야 함.|
