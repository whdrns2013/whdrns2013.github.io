---
title: 코딩테스트 없는 숫자 더하기 (프로그래머스) # 제목
excerpt: # 서브 타이틀
date: 2022-12-27 20:33:00 +0900      # 작성일
lastmod: 2022-12-27 20:33:00 +0900   # 최종 수정일 : 구글 사이트등록 관련 필요
...
def solution(numbers):
    ...
    range_10 = [ x for x in range(10)]
    answer = sum([ x for x in range_10 if x not in numbers])
