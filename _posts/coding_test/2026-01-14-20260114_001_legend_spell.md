---
title: 코딩테스트 봉인된 주문 풀이 (프로그래머스) 파이썬 # 제목
excerpt: "문자형과 아스키코드, 이진탐색" # 서브 타이틀
...
tags: 프로그래머스 코딩테스트 파이썬 이진탐색 아스키코드 아스키 코드 문자형 변환                    # 태그 복수개 가능
...
![](/assets/images/20260114_001_001.png)
