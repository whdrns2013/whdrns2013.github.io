---
title: "[홈서버] 정말 쉬운 리눅스 가상화 환경, 가상화 플랫폼 만들기 - KVM과 Cockpit" # 제목 (필수)
...
KVM은 리눅스 커널에 내장된 하이퍼바이저 기술로, 커널 레벨에서 동작하는 가상화 엔진입니다. 쉽게 말해, 일반적인 리눅스를 가상화 호스트로 변환하고, 그 위에 여러 개의 가상 머신(VM)을 실행할 수 있도록 해주는 기반 기술이라고 볼 수 있습니다.  
