...
### docker export - 컨테이너를 파일로 추출하기  

먼저, <b><font color="FF82B2">실행 중인 도커 컨테이너를 파일로 추출</font></b>  하려면 `docker export` 명령어를 사용합니다. 이 명령어는 컨테이너의 파일 시스템을 tar 아카이브로 내보냅니다. <b>마운트된 디렉토리는 tar 파일에 저장되지 않습니다.</u>  
